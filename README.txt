...
If you want to create fresh SSL keys to be used with your python https server then run gen-SSL-keys_start-server_x0r instead.  This way you can use fresh keys with each https instance if you want.
